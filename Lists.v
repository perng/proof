...
Fixpoint subset (s1:bag) (s2:bag) : bool :=
  match s1 with
  | nil => true
  | h1::t2 => match member h1 s2 with
              | false => false
              | true => subset t2 (remove_one h1 s2)
              end
                end.
...
Theorem rev_sum: forall l1 l2:natlist,
...
Proof.
  ...
  - simpl. reflexivity.
  - simpl. rewrite -> rev_sum. rewrite -> IHl. simpl. reflexivity.
Qed.
...
=======
(**
>>>>>>> 4a30fcb4ca46ce7fd6e710ad960994b451100605
...
Qed.
  (** [] *)
=======
  intros. destruct x. simpl. induction n as [|n'].
  - reflexivity.
  - simpl. rewrite <- IHn'. reflexivity.
Qed.
(** [] *)
